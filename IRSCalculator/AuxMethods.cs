...
public static class AuxMethods
{
    ...
    public static string ReplacingInCalculationFormula(string calculationFormula, double grossSalary)
        => calculationFormula.Replace("%", "/100").Replace("x", "*").Replace("R", grossSalary.ToString()).Replace(",", ".");
